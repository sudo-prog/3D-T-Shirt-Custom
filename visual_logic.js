...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        bindListener, getElement, getElements, getSceneAnimFrameRate,
        getSceneByAction, getMaterialEditableTextures, replaceMaterialEditableTexture, getMaterialEditableColors,
        getMaterialEditableValues, getObjectByName, retrieveObjectNames, isBlobUrl,
        isDataUrl, convertObjToJsonDataUrl, convertObjToTextDataUrl,
    };
};
...
initFullscreen('fullscreenbutton', true, function() {}, function() {}, function() {});
...
this.procedures["restore_saved_canvas_layers"] = restore_saved_canvas_layers;
...
this.procedures["restore_garment_effect_sliders"] = restore_garment_effect_sliders;
...
var VARS = Object.defineProperties({}, {
    'loadSavedLayout': { get: function() { return loadSavedLayout; }, set: function(val) { loadSavedLayout = val; } },
    'openuv': { get: function() { return openuv; }, set: function(val) { openuv = val; } },
    'Controls_Hide': { get: function() { return Controls_Hide; }, set: function(val) { Controls_Hide = val; } },
    'myDrawer2': { get: function() { return myDrawer2; }, set: function(val) { myDrawer2 = val; } },
    'openuv2': { get: function() { return openuv2; }, set: function(val) { openuv2 = val; } },
    'currentSceneState': { get: function() { return currentSceneState; }, set: function(val) { currentSceneState = val; } },
    'color': { get: function() { return color; }, set: function(val) { color = val; } },
    'bgColor': { get: function() { return bgColor; }, set: function(val) { bgColor = val; } },
    'loadedData': { get: function() { return loadedData; }, set: function(val) { loadedData = val; } },
    'puffPrint': { get: function() { return puffPrint; }, set: function(val) { puffPrint = val; } },
    'acidWash': { get: function() { return acidWash; }, set: function(val) { acidWash = val; } },
    'value': { get: function() { return value; }, set: function(val) { value = val; } },
    'camera_bgs': { get: function() { return camera_bgs; }, set: function(val) { camera_bgs = val; } },
    'myDrawer3': { get: function() { return myDrawer3; }, set: function(val) { myDrawer3 = val; } },
    'imagebg': { get: function() { return imagebg; }, set: function(val) { imagebg = val; } },
    'tshirts': { get: function() { return tshirts; }, set: function(val) { tshirts = val; } },
    'anims': { get: function() { return anims; }, set: function(val) { anims = val; } },
    'eventName': { get: function() { return eventName; }, set: function(val) { eventName = val; } },
    'valuesObject': { get: function() { return valuesObject; }, set: function(val) { valuesObject = val; } },
});

var loadSavedLayout, currentSceneState, myDrawer3, imagebg, tshirts, anims, eventName, valuesObject, openuv, Controls_Hide, color, value, openuv2, bgColor, myDrawer2, loadedData, puffPrint, camera_bgs, acidWash;
...
function cf_drawInit() {
    return (function (selector, toolsPanelSide, containerWidth, containerHeight, canvasScale, extensionsJSON, backgroundLayers, containerBackgroundLayers) {
            ...
            if (selector != '') {
                ...
                if (document.querySelector('#cf-theme-styles') == null && window['Konva'] !== undefined) {
                    var style = document.createElement('style');
                ...
                const getResponseInputCheck = () => window.innerWidth > responsiveDivider ? true : false;
                    ...
                    if (extensions.add_draw_mode) {
                        ...
                        stage.on('mousemove touchmove', function () {
                            ...
                            if (stage.cfDrawingConfig.cfIsPaint) {
                                ...
                                var newPoints = stage.cfDrawingConfig.lastLine.points().concat(
                                    [pos.x, pos.y]);
                    ...
                    `;
                        ...
                        contextMenuNode.querySelectorAll('.cf_context-menu__button').forEach(function (item) {
                            item.addEventListener('click', (e) => {
                                ...
                                const tr = layer.find('Transformer').toArray()
                                    .find(tr => tr.nodes()[0] === stage.cfTransforming.currentShape);
...
var VARS = Object.defineProperties({}, {
  ...
  if (featureAvailable('MOBILE')) {
    ...
    myDrawer2 = cf_drawInit(['QUERYSELECTOR', '#myClass'], "right", 340, 340, 4, '{"add_image_upload_mode":true,"add_transform_mode":true}', (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/none.png', stage, layer, isWrapperLayer)}catch(ex){}}, (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/placementguide.jpg', stage, layer, isWrapperLayer)}catch(ex){}});
    /* Add close button */
    addHTMLElement('button', 'closecanvas', 'AFTER', ['QUERYSELECTOR', '#myClass .cf_state-reset'], false);
    ...
    if (loadSavedLayout) {
      ...
      Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('const stageId = VARS.myDrawer2.dataset.stage;' + '\n' +
      ...
      '}' + '\n' +
      'layer.draw();' + '\n' +
      'document.querySelector(\'#myClass .cf_tools-toggle\').click();')))(appInstance, v3d, PL, VARS, PROC);

    }
    replaceTexture('Base', 'yourdesignhere.png.001', myDrawer2, function() {});
  } else {
    setHTMLElemAttribute('innerHTML', '', 'myClass', false);
    myDrawer2 = cf_drawInit(['QUERYSELECTOR', '#myClass'], "right", 450, 450, 4, '{"add_draw_mode":true,"add_drawing_tools_mode":true,"add_transform_mode":true,"add_text_mode":true,"add_image_upload_mode":true}', (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/none.png', stage, layer, isWrapperLayer)}catch(ex){}}, (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/placementguide.jpg', stage, layer, isWrapperLayer)}catch(ex){}});
    /* Add close button */
    addHTMLElement('button', 'closecanvas', 'TO', ['QUERYSELECTOR', '#myClass .cf_drawing'], false);
    setHTMLElemAttribute('innerHTML', 'X', 'closecanvas', false);
    setHTMLElemAttribute('className', 'cf_button', 'closecanvas', false);
    setHTMLElemStyle('marginLeft', '220px', 'closecanvas', false);
    /* add export/import buttons to the drawer interface */
    setCSSRuleStyle('padding', '10px', '.cf_button', false, '');
    addHTMLElement('button', 'exportButton', 'BEFORE', ['QUERYSELECTOR', '#myClass .cf_state-reset'], false);
    setHTMLElemAttribute('className', 'cf_button', 'exportButton', false);
    setHTMLElemAttribute('innerHTML', ' Save Layout', 'exportButton', false);
    eventHTMLElem('click', 'exportButton', false, function(event) {
      export_layout_to_file();
    });
    addHTMLElement('button', 'importButton', 'BEFORE', ['QUERYSELECTOR', '#myClass .cf_state-reset'], false);
...
function import_layout_from_file() {
  openFile(function() {
    loadFile(openedFile('DATA'), function() {
      ...
      Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('const alertMsg = \'Wrong save file! Try another one.\';' + '\n' +
      '' + '\n' +
      'try {' + '\n' +
...
function restore_saved_canvas_layers() {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('const state = VARS.currentSceneState;' + '\n' +
  '' + '\n' +
...
function export_layout_to_file() {
  ...
  '' + '\n' +
  'state.savedImages = {};' + '\n' +
  'state.savedLayers = {};')))(appInstance, v3d, PL, VARS, PROC);
...
function restore_garment_effect_sliders() {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('const slider = parent.document.querySelector(\'#slider-single-2\');' + '\n' +
  ...
  'elem.innerHTML = slider.value;')))(appInstance, v3d, PL, VARS, PROC);


  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('const slider = parent.document.querySelector(\'#slider-single-3\');' + '\n' +
...
function create_bg_canvas() {
  if (getHTMLElemAttribute('innerHTML', 'myClass2', false) == '') {
    myDrawer3 = cf_drawInit(['QUERYSELECTOR', '#myClass2'], "right", 400, 400, 4, '{"add_draw_mode":true,"add_drawing_tools_mode":true,"add_image_upload_mode":true,"add_transform_mode":true,"add_text_mode":true}', (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/none.png', stage, layer, isWrapperLayer)}catch(ex){}}, (stage, layer, isWrapperLayer = false) => {  try{cf_stageBackgroundLayerImage('./canvas_bg/background.jpg', stage, layer, isWrapperLayer)}catch(ex){}});
...
operateAnimation('PLAY', 'tshirt_pivot', null, null, 'LoopOnce', 1,
        function() {}, false);
...
eventHTMLElem('click', 'exportimage', true, function(event) {
  downloadFile(appInstance.renderer.domElement.toDataURL('image/png'), 'Virtualthreads.png');
});
...
operateAnimation('PAUSE', anims, null, null, 'AUTO', 1,
        function() {}, false);


eventHTMLElem('input', 'slider-single', true, function(event) {

  operateAnimation('SET_SPEED', 'tshirt_walking', null, null, 'AUTO', getHTMLElemAttribute('value', 'slider-single', true),
          function() {}, false);


  operateAnimation('SET_SPEED', 'tshirt_waves', null, null, 'AUTO', getHTMLElemAttribute('value', 'slider-single', true),
          function() {}, false);
...
eventHTMLElem('input', 'slider-single-4', true, function(event) {
  ...
  operateAnimation('SET_SPEED', 'tshirt_walking', null, null, 'AUTO', getHTMLElemAttribute('value', 'slider-single-4', true),
          function() {}, false);


  operateAnimation('SET_SPEED', 'tshirt_waves', null, null, 'AUTO', getHTMLElemAttribute('value', 'slider-single-4', true),
          function() {}, false);
...
operateAnimation('STOP', 'camrotatezoomaxis', null, null, 'AUTO', 1,
        function() {}, false);


operateAnimation('STOP', 'camrotateaxis', null, null, 'AUTO', 1,
        function() {}, false);
...
eventHTMLElem('input', 'slider-single-5', true, function(event) {
  setMaterialValue('Base', 'Value.003', getHTMLElemAttribute('value', 'slider-single-5', true));
});
/* Puff Print Slider */
eventHTMLElem('input', 'slider-single-6', true, function(event) {
  setMaterialValue('Base', 'Value.004', getHTMLElemAttribute('value', 'slider-single-6', true));
});
